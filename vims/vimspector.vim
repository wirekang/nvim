...
nmap <leader>id :<c-u>VimspectorReset<cr>
nmap <leader>itc <Plug>VimspectorToggleConditionalBreakpoint
nmap <leader>it <Plug>VimspectorToggleBreakpoint
nmap <leader>iso <Plug>VimspectorStepOver
